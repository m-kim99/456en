...
@IBDesignable open class Switch: UIControl {
  ...
  static let buttonFactory: () -> UIButton = {
    let button = UIButton()
  ...
  public let leftButton = buttonFactory()
  ...
  public let rightButton = buttonFactory()
  ...
  open override func layoutSubviews() {
    ...
    leftButton.frame = CGRect(x: 0, y: 0, width: bounds.size.width / 2, height: bounds.size.height)
    rightButton.frame = CGRect(x: bounds.size.width / 2, y: 0, width: bounds.size.width / 2, height: bounds.size.height)
  }
  ...
  open override func sizeThatFits(_ size: CGSize) -> CGSize {
    ...
    return desiredSizeForLeftSize(leftButton.sizeThatFits(labelSize), rightSize: rightButton.sizeThatFits(labelSize))
  }

  /// The minimum size used for Auto Layout.
  open override var intrinsicContentSize: CGSize {
    return desiredSizeForLeftSize(leftButton.intrinsicContentSize, rightSize: rightButton.intrinsicContentSize)
  }
  ...
  func reloadLabelsTextColor() {
    leftButton.setTitleColor(rightSelected ? disabledColor : tintColor, for: .normal)
    rightButton.setTitleColor(rightSelected ? tintColor : disabledColor, for: .normal)
  }
