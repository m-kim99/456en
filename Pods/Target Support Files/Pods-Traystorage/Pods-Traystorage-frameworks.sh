...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ActionSheetController/ActionSheetController.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ModalTransitioning/ModalTransitioning.framework"
